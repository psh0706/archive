...
+ **요약**  
	...
	|2| play_info.py | 1의 결과를 이용해 상세 정보를 크롤링 |  |  |  
	|3| play_review.py | 1의 결과를 이용해 리뷰 크롤링 | |  |  
...
+ **요약**  
	|INDEX|코드명|요약설명|LOC|비고|
	|:---:|:--- | :--- |:---:|:---|
	|1| 2-gram_image.py | 바이그램을 워드클라우드화 하여 저장 | 참잘했어요. |  |  
	...
	|5| emolex_to_img.py | 4의 결과를 이용해 chart img를 저장 |  |  |  |  
	|6| TF-IDF.ipybn | 도시별 레스토랑들의 TF-IDF 값을 계산해 저장 |  |  |jupyter|  
***	
### Web
+ **사족**  
